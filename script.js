...
send.forEach(btn => btn.addEventListener('click', closeModal));
...
message.innerHTML =
  'Thanks for visiting! This is just a cookie 😄 <button class="btn btn--close-cookie">Got it!</button>';
...
btnScrollTo.addEventListener('click', function (e) {
  const s1coords = section1.getBoundingClientRect(); //current position relative to viewport
...
tabsContainer.addEventListener('click', function (e) {
  ...
  tabsContent.forEach(t => t.classList.remove('experience__content--active'));
  document
...
// STICKY NAVIGATION BEST APPROACH
